import type { fromMarkdown, OnEnterError, OnExitError, Token } from "mdast-util-from-markdown"
import type { toMarkdown, State, Tracker } from "mdast-util-to-markdown"
import type { Point } from "unist"
import type { MdxJsxAttribute, MdxJsxAttributeValueExpression, MdxJsxExpressionAttribute, MdxJsxFlowElement, MdxJsxTextElement } from "../index.js"
...
function inferDepth(state: State): number {
    let depth = 0
